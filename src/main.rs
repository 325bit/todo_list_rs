use backend::{delete_todo, list_todos, login, register, save_todo};
...
// Authentication Component (Register & Login Forms)
#[component]
fn Auth() -> Element {
    ...
    rsx! {
        div { display: "grid", grid_template_columns: "1fr 1fr", gap: "20px",
